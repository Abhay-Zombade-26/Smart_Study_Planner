...
public class StudyDashboardDialog extends JDialog {
    ...
    private JPanel createTablePanel() {
        ...
        String[] columns = {"Date", "Description", "Status", "Session Type"};
    ...
    class StatusCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            } else if ("MISSED".equals(text)) {
                badge.setText("Missed");
                badge.setForeground(Color.WHITE);
                badge.setBackground(DANGER_COLOR);
            } else if ("PENDING".equals(text)) {
    ...
    private void loadTasks() {
        ...
        List<StudyTask> tasks = taskDAO.findAllTasksByUser(user.getId());
        ...
        for (StudyTask task : tasks) {
            ...
            if (task.getTaskDate().equals(today)) {
                ...
                todayTasks.append(task.getDescription());
                hasTodayTask = true;
            }
        }
